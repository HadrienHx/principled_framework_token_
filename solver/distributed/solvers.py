...
from solver.distributed.token_vr import Token_VR
from solver.distributed.walkman import Walkman
from solver.distributed.token_skip import Token_skip


class AvailableSolvers(object):
    solvers  = {
                "TokenSkip": Token_skip, 
                "Walkman": Walkman,
                "TVR": Token_VR,
                "Token": Token_algo,
                "EXTRA": Extra,
