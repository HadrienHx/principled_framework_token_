...
class Plotter(object):
    ...
    def plot(self, show=True, preset_times=None, xlabel=None):
    ...
    def save(self, output_path=None, save_png=False, suffix="", filename=None):
        path = os.path.join(output_path, filename + "_" + suffix)
        self.log.info(path)
        self.dump(path)
        if save_png:
